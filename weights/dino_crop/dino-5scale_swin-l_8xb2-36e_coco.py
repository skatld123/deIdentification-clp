...
test_evaluator = dict(
    ...
    format_only=False,
    backend_args=None,
    outfile_prefix='./work_dirs/clp_detection/dino_crop/')
default_scope = 'mmdet'
default_hooks = dict(
    ...
    checkpoint=dict(
        ...
        interval=5,
        save_best='auto',
        out_dir='/root/mmdetection/work_dirs/dino_crop_50'),
...
log_level = 'INFO'
load_from = 'work_dirs/dino_crop_50/best_coco_bbox_mAP_epoch_27.pth'
resume = False
model = dict(
    type='DINO',
    num_queries=900,
...
num_levels = 5
work_dir = '/root/mmdetection/work_dirs/dino_crop_50'
log_config = dict(
    interval=100,
