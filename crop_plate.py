...
import numpy as np
import config as cf
from deId import deIdentify, rectifyPlate
...
if __name__ == '__main__':
    ...
    rectifyPlate(result_dic=dic_bbox_with_point, 
                 data_path=cfg_en['input_img'], 
                 crop_path=cfg_lm['input_dir'], 
                 save_path='/root/deIdentification-clp/result/retify_img')