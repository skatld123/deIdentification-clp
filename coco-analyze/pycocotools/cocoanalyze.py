...
class COCOanalyze:
    ...
    def __init__(self, cocoGt, cocoDt, iouType='keypoints'):
        ...
        # self.cocoEval.params.kpt_oks_sigmas = np.array([.5, .5, .5, .5]) / 10.0
        # self.cocoEval.params.kpts_name = [u'lt',u'rt', u'rb',u'lb']
        # self.cocoEval.params.inv_kpts_name = [u'lt',u'rt', u'rb',u'lb']
        # self.cocoEval.params.num_kpts = 4
        # self.cocoEval.params.inv_idx  = [self.params.inv_kpts_name.index(self.params.kpts_name[i]) for i in range(self.params.num_kpts)]
        # gt for analysis
...
class Params:
    ...
    def setKpParams(self):
        ...
        self.sigmas   = np.array([1.0,1.0,1.0,1.0])
