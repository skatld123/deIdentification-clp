...
default_hooks = dict(
    ...
    checkpoint=dict(
        ...
        interval=5,
        save_best='auto',
        out_dir='/root/license_plate_mmdetection/work_dirs/dino_crop_aug_150'),
...
log_level = 'INFO'
load_from = 'work_dirs/dino_crop_aug_150/best_coco_bbox_mAP_epoch_16.pth'
resume = False
model = dict(
    type='DINO',
    num_queries=900,
...
num_levels = 5
work_dir = '/root/license_plate_mmdetection/work_dirs/dino_crop_aug_150'
num_classes = 1
geometric_space = [
