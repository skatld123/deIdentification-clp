...
import numpy as np
import config as cf
from deId import deIdentify_blur_or_mask
...
if __name__ == '__main__':
    ...
    # 출력을 COCO형식으로 변경
    result_json_path = cf.one_stage_output + "/result_coco.json" 
    coco_evaluate_offline(gt_path=cf.gt_json_path, pd_path=cfg_one['output_json'], output_path=result_json_path)
    ...
    cal_mAP(cfg_one['num2class'], detections, groundtruths, classes)
